 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://www.jboss.org/eap/quickstarts/wscalculator/Calculator", wsdlLocation = "file:/Users/usuario/Documents/GitHub/moonshot/src/main/resources/CalculatorService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://www.jboss.org/eap/quickstarts/wscalculator/Calculator", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/Users/usuario/Documents/GitHub/moonshot/src/main/resources/CalculatorService.wsdl");
    ...
    public CalculatorService getCalculator() {
        return super.getPort(new QName("http://www.jboss.org/eap/quickstarts/wscalculator/Calculator", "Calculator"), CalculatorService.class);
    }
    ...
    public CalculatorService getCalculator(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.jboss.org/eap/quickstarts/wscalculator/Calculator", "Calculator"), CalculatorService.class, features);
    }
